...
|Power BI|Visaulizing the data via interactive dashborads|
|GitHub|Hosting the project documentation and version control|
|Mokkup AI|Designing the wareframe/mockup of the dashboard|
...
```
#### Output
![Youtubers with Most Subscribers](assets/images/youtubers_with_the_most_subs.png)
...
```
#### Output
![Youtuber with Most Uploaded Videos](assets/images/youtubers_with_the_most_videos.png)
